  ...
  return (
    <div className="w-full relative rounded-2xl border border-border/40 bg-card overflow-hidden glow-sm">
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-secondary/40 border-b border-border/40">
        ...
        <div className="flex-1 max-w-md mx-auto h-7 bg-background/50 rounded-lg border border-border/30 px-3 flex items-center justify-between text-xs text-muted-foreground select-none">
      ...
      <div className="p-6 md:p-8 bg-background/60 min-h-[320px] flex flex-col justify-between relative overflow-hidden">
              ...
              <motion.div key="features" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  {["Responsive Grids", "GSAP Scroll Animations", "Headless CMS Synced", "Interactive Canvas", "GDPR Cookie Protection", "Dark/Light Native Support"].map(f => (
                    <div key={f} className="p-2 border border-border/40 rounded-lg bg-card/60 flex items-center gap-2">
        ...
        {/* Tab triggers */}
        <div className="mt-8 pt-4 border-t border-border/30 flex items-center gap-2 overflow-x-auto whitespace-nowrap scrollbar-none">
          {[
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-heading font-extrabold text-foreground leading-[0.95] mb-6">
                Websites That Load <span className="gradient-text">Instantly.</span><br />Built to Convert.
              </h1>
            ...
            {/* Right: Interactive browser showcase */}
        ...
        <div className="container-tight">
          <motion.div {...fadeUp} className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-5xl font-heading font-bold text-foreground mb-5">
              Custom Web Solutions <span className="gradient-text">Built From Scratch</span>
            </h2>
            ...
            {webServices.map((svc, i) => {
              ...
              return (
                <motion.div key={svc.title} {...stagger(i)} className="gradient-border bg-card rounded-2xl p-7 group hover:glow-sm transition-all duration-500">
                  <div className="w-11 h-11 gradient-primary rounded-xl flex items-center justify-center mb-5 glow-sm">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeUp}>
              ...
              <h2 className="text-3xl md:text-5xl font-heading font-bold text-foreground mb-6 leading-tight">
                How Custom Code <span className="gradient-text">Differs From Templates</span>
              </h2>
      ...
      <section id="capabilities" className="section-padding bg-background">
        <div className="container-tight">
          <motion.div {...fadeUp} className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-5xl font-heading font-bold text-foreground mb-5">
              Modern Technologies <span className="gradient-text">We Work With</span>
            </h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div key={st.cat} {...stagger(i)} className="gradient-border bg-card rounded-2xl p-6">
        ...
        <div className="container-tight relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <motion.div {...fadeUp}>
              ...
              <h2 className="text-3xl md:text-5xl font-heading font-bold text-foreground mb-6 leading-tight">
                Start Your Web <span className="gradient-text">Project Today</span>
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-8">
        ...
        <div className="container-tight max-w-3xl mx-auto">
          <motion.div {...fadeUp} className="text-center mb-12">
            <h2 className="text-2xl md:text-4xl font-heading font-bold text-foreground mb-4">
              Web Development <span className="gradient-text">FAQs</span>
            </h2>
